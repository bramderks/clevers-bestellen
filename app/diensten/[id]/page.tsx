...
export default async function DienstPagina({
  ...
  const [dienst, medewerkers] = await Promise.all([
    ...
    <main className="min-h-screen bg-slate-100 px-4 py-8 md:p-10">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="text-3xl font-bold">Dienst bewerken</h2>
          ...
          <DienstForm
            ...
            dienst={{
              id: dienst.id,
              medewerkerId: dienst.medewerkerId,
              datum: dienst.datum.toISOString().split("T")[0],
              begintijd: dienst.begintijd,
              eindtijd: dienst.eindtijd,
              vestigingId: dienst.vestigingId ?? "",
              vestiging: dienst.vestigingSnapshot,
              functie: dienst.functie ?? "Medewerker",
            }}
          />
